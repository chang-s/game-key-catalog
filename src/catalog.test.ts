...
describe('catalog filtering',()=>{
  ...
  it('shows out-of-stock separately',()=>expect(filterGames(games,{...base,availability:'Out of Stock'}).map(game=>game.id)).toEqual(['008','024','027','028','029','043','048','049','055','056','060','072','076','077','109','118','130','164','165','169','174']));
});
