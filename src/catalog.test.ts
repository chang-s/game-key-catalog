...
describe('catalog filtering',()=>{
  ...
  it('uses OR logic for multiple platforms',()=>expect(filterGames(games,{...base,platforms:['Steam','Xbox']}).map(game=>game.id)).toEqual(['003','009','010','011','014','015','016','018','023','026','030','035','039','041','042','052','053','057','058','059','062','063','064','065','066','067','068','069','075','078','079','080','083','084','085','086','087','088','093','094','096','097','110','111','112','113','114','115','116','117','119','120','121','122','126','127']));
  it('uses OR logic for multiple genres',()=>expect(filterGames(games,{...base,genres:['Shooter','Roleplaying']}).map(game=>game.id)).toEqual(['001','002','003','005','006','009','010','012','013','017','020','022','023','031','034','035','038','040','047','051','054','057','059','062','063','064','065','070','075','087','090','092','100','101','102','103','104','105','106','107','112','119','120','121','124','125','127','128']));
  it('uses OR logic for multiple offer types',()=>expect(filterGames(games,{...base,offers:['Full Game','Subscription']}).map(game=>game.id)).toEqual(['003','004','005','014','016','022','034','035','038','039','040','041','042','047','050','051','054','059','062','063','064','065','066','067','068','069','073','075','079','080','081','082','084','085','089','090','091','092','094','095','097','098','099','100','101','102','103','104','105','106','107','108','112','113','114','115','116','117','120','122','123','124','125','127','128','129','131']));
  it('uses AND logic across categories',()=>expect(filterGames(games,{...base,platforms:['Steam','Xbox'],genres:['Shooter','Roleplaying'],offers:['Full Game']}).map(game=>game.id)).toEqual(['003','035','059','062','063','064','065','075','112','120','127']));
